...
Throughout the entire thesis, to perform calculations and efficiently manipulate spinor-product expressions, we exploited the Mathematica package \texttt{S@M}~\cite{Maitre:2007jq}. 
