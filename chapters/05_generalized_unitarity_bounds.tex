...
\begin{enumerate}
    \item Decomposition of the helicity amplitudes $\mathcal A$ into partial waves $a^J$ with fixed total angular momentum $J$ by means of the Wigner (small) $d$-matrix~\cite{Jacob:1959at,Varshalovich:1988ifq}:
    \begin{equation}
