...
On the theoretical side, perturbative unitarity --- relying on the properties of the scattering $S$-matrix --- provides an independent and complementary way to infer upper limits on the strength of such interactions, irrespectively of any experimental information.
...
\begin{enumerate}
    ...
    \item Diagonalization of the partial-wave scattering matrix. In this coupled-channel analysis, the most stringent limit is then obtained by imposing the partial-wave unitarity bound $\abs*{a^J}\le 1$ on the largest eigenvalues.
\end{enumerate}
...
are expected to dominate at high energies, which can be probed at future colliders such as FCC-ee~\cite{FCC:2018byv} or a high-energy muon collider~\cite{Accettura:2023ked}.
...
\lb{Insert outline of the chapter.}
...
Moreover, we considered unitarity bounds for spin-2 or higher-spin theories --- relevant for effective field theories of gravity --- that are not approachable by standard methods; see Figures~\ref{fig:s1} and \ref{fig:s2_v2}. 

Finally, we emphasized the complementarity of positivity and partial-wave unitarity bounds to probe the parameter space of effective field theories, as shown in Figures~\ref{fig:s1}--\ref{fig:s2_v2}.
