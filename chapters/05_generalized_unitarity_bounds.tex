...
\draw[color=Maroon,very thick,densely dotted] (t1) to [] (t2);
\node[] (t3) at (1,-1.35) {};
\node[] (t4) at (1,-0.35) {\scriptsize$i$};
\draw[color=Maroon,very thick,densely dotted] (t3) -- (t4);
\end{tikzpicture}}\,,
...
\begin{gather}
    ...
    \node[] (cut1) at (1,0.65) {};
    \node[] (cut2) at (1,-0.65) {};
    \draw[color=Maroon,very thick,densely dotted] (cut1) -- (cut2);
...
\section{$N \to M$ Scattering Amplitudes}
