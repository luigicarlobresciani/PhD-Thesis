...
Such a theoretical prediction was of paramount importance in motivating the construction of the LHC at CERN. 
...
and at future colliders such as the FCC~\cite{FCC:2018byv} or a high-energy muon
...
to be connected to weakly coupled conformal field theories through the AdS/CFT correspondence~\cite{Klebanov:2002ja}. The recent direct observation of gravitational waves from merging black holes~\cite{LIGOScientific:2016aoc,LIGOScientific:2018mvr,KAGRA:2021vkt} opens the possibility of probing the theory of gravity in the strong regime at an unprecedented level. It is therefore very interesting to explore which EFT extensions of gravity could be detected. In this respect, our work serves as an important guide for exploring viable models that are consistent with first principles of quantum field theory.
...
on the Wilson coefficients to ensure compatibility with a well-behaved UV completion.
%
