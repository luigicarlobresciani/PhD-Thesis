\chapter{Angular Momentum Basis for $2 \to 3$ Amplitudes\label{app:2-to-3_basis}}

In this appendix we list the normalized kinematic polynomials with definite angular momentum $J_{12}$ relevant for $2 \to 3$ helicity amplitudes.
