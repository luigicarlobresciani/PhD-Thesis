...
\noindent As recalled in Chapter~\ref{ch:RGEmethod}, the Standard Model (SM) of particle physics, describing
...
ultraviolet theory entailing new dynamics emerging at some large, yet unknown, energy scale $\Lambda$.
...
on specific ultraviolet completions. Physical observables are then obtained by computing matrix
...
The renormalization group equations (RGEs) of the Standard Model EFT extended with a CP-odd ALP have
