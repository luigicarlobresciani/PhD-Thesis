...
The work presented in this thesis is primarily based on published articles written during my PhD work at Dipartimento di Fisica e Astronomia ``Galileo Galilei'', Università degli Studi di Padova, Italy.
...
\item[\cite{Bresciani:}]
L.~C.~Bresciani and N.~Selimovic,
``All-Order Helicity Selection Rules in Effective Field Theories,''
[\href{https://doi.org/}{arXiv:2609.xxxxx} [hep-ph]].

\item[]
L.~C.~Bresciani, P.~Paradisi and A.~Sainaghi,
``Unitarity bounds and spinning sum rules in the flavorful SMEFT,''
(to be published).
\end{itemize}
...
\href{https://doi.org/10.1393/ncc/i2026-26061-0}{Nuovo Cim. C \textbf{49} (2026) no.1-2, 61}.
\end{itemize}