...
such as the smallness of the CP-violating angle of QCD, the hierarchical
...
energies where it is applied and must admit an ultraviolet (UV) completion with a unitary, causal, and local
...
account. The SMEFT assumes that no light states other than those of the
...
in mass-independent schemes such as the modified minimal-subtraction scheme~\cite{tHooft:1973mfk,Weinberg:1973xwm,Bardeen:1978yd},
