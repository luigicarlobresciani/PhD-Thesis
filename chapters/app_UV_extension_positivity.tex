\section{Positivity Bounds in an Ultraviolet Extension\label{app:UVext}}
...
A simple way to generate at tree level the operators subject to the positivity constraints consists of integrating out a massive spin-2 field $h_{\mu\nu}$ minimally coupled to the stress-energy tensor $T_{\mu\nu}$ \cite{Fierz:1939ix,Hinterbichler:2011tt}:
\begin{equation}
