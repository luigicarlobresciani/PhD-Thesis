...
\bottomrule
\end{tabular}
\caption{Comparison of the single-operator unitarity bounds (i.e., obtained by switching on one operator at a time) on the modulus of the Wilson coefficients
