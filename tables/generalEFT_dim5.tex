...
\toprule
\rowcolor{hdrcolor}
\text{\textbf{Name}} & \text{\textbf{Operator}} &  \text{\textbf{Symmetry}} & \text{\textbf{Form factor}} \\
\midrule
...
\end{align*}
\caption{Dimension-five bosonic and fermionic operators of the general EFT, together with their minimal form factors and the symmetry properties of the associated Wilson coefficients. The symmetry factor $\mathcal S_{\alpha\beta}$ is defined as $\mathcal S_{\alpha\beta} = 1 + \delta_{\alpha\beta}$.}
\label{tab:dim5}
\end{table}
%%%
% --- END TABLE
